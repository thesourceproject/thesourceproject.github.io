<template>
  <main class="mt-12">
    <section class="max-w-4xl mx-auto flex flex-col">
      <h1 class="text-3xl font-bold">
        <span class="hidden sm:block">
          For Fun<span class="text-text-3">.</span> For Learning<span
            ...
            >.</span
          >
          For Everyone<span class="text-text-3">.</span>
        </span>
        <span class="sm:hidden">
          For Fun<span class="text-text-3">.</span><br />
          For Learning<span class="text-text-3">.</span><br />
          For Everyone<span class="text-text-3">.</span>
        </span>
      </h1>
      <p class="mt-12">
        ...
        Javascript, Python and so on. Whether you want to build softwares, games
        or web applications, our tutorials will definitely assist you.
      </p>
      <p class="mt-6">
        So, let's
        <NuxtLink
      ...
      <div class="mt-16 grid justify-evenly items-center gap-8 md:grid-cols-2">
        <div class="flex items-center">
          ...
          <div class="ml-8 flex flex-col">
            <h3 class="text-xl font-bold">Kritika</h3>
            <p class="mt-3">I design stuff</p>
            <div class="mt-4 flex">
              <a
                rel="noopener noreferrer"
                href="https://github.com/Kritika9624"
                target="_blank"
                ><svg
                  class="h-8 w-8"
              ...
              ><a
                rel="noopener noreferrer"
                class="ml-4 h-8 w-8"
                href="https://dribbble.com/Kitty_s"
                target="_blank"
                ><svg
                  fill="currentColor"
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex items-center">
          ...
          />
          <div class="ml-8 flex flex-col">
            <h3 class="text-xl font-bold">Yetendra</h3>
            <p class="mt-3">I build stuff</p>
            <div class="mt-4 flex">
              <a
                rel="noopener noreferrer"
      ...
      <p class="mt-36 text-center">Have a query? Reach us at</p>
      <a
        rel="noopener noreferrer"
      ...
      >
        ...
        <p class="ml-3 text-lg">thesourceprojectteam@gmail.com</p>
      </a>
      <a
        rel="noopener noreferrer"
        href="mailto:thesourceprojectteam@gmail.com"
